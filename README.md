...
* [ETL_Orable_To_BQ](https://github.com/technqvi/MIS-FinData/tree/main/ETL_Orable_To_BQ) : script to ingest data from any databased to BigQuery, we can schecule it on Window Task Scheduler.
